	...
	<div>
		...
		<div class="tubiao">
			<div class="w">
				<div>合作伙伴</div>
				<ul>
					<li><a href=""><img src="../assets/b1 (5).png" alt=""></a></li>
					<li><a href=""><img src="../assets/b1 (3).png" alt=""></a></li>
					<li><a href=""><img src="../assets/b1 (1).jpg" alt=""></a></li>
					<li><a href=""><img src="../assets/b1 (1).png" alt=""></a></li>
					<li><a href=""><img src="../assets/b1 (4).png" alt=""></a></li>
					<li><a href=""><img src="../assets/b1 (2).png" alt=""></a></li>
				</ul>
			</div>
		</div>
	</div>
...
<style type="text/css" scoped lang="scss">
	...
	.tubiao{
			...
			.w{
				div{width:150px;height:74px;font-size: 20px;color: #363b3f; text-align: center;line-height: 74px; display: inline-block;float: left;}
				ul{
					height: 74px;
					li{
						display: inline-block;
